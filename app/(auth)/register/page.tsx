...
export default function RegisterPage() {
  ...
  const handleCompleteSetup = async () => {
    ...
    setError("");
    // TODO: Save name/email to backend
    window.location.href = "/account";
  };
      ...
      <div className="flex w-full flex-col items-center justify-center bg-[var(--color-ivory)] px-page md:w-1/2">
        <div className="w-full max-w-sm">
          <h2 className="font-display text-2xl font-medium text-[var(--color-obsidian)]">
            {step === "profile" ? "Almost there!" : "Create account"}
          </h2>
            ...
            <div className="mt-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-md border border-[var(--color-border)] bg-[var(--color-white)] px-3 py-2.5 text-sm text-[var(--color-obsidian)] placeholder:text-[var(--color-warm-gray)] focus:border-[var(--color-gold)] focus:outline-none"
                />
              </div>
              ...
              <div>
                <label className="text-[11px] font-medium uppercase tracking-widest text-[var(--color-obsidian)]">
                  Email{" "}
                  <span className="normal-case tracking-normal text-[var(--color-warm-gray)]">
                    (Optional)
                  </span>
                </label>
                <input
